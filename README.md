...
* Future-Proof API: Utilizes the latest capitalized Flet 0.80+ styling classes (Margin, BorderRadius, Padding) ensuring a 100% clean terminal with zero deprecation warnings.
